...
;; ## added by OPAM user-setup for emacs / tuareg ## 763c5dcce5893dc1d3d2710af30568be ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/gypsydave5/.opam/4.10.0/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## fe488d6b4edf0e41214956adb041b389 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/gypsydave5/.opam/4.10.0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
